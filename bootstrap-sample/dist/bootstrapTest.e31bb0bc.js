...
var Dropdown = /*#__PURE__*/function (_BaseComponent) {
  ...
  _proto.show = function show() {
    ...
    if (!this._inNavbar) {
      ...
      this._popper = (0, Popper.createPopper)(referenceElement, this._menu, this._getPopperConfig());
...
var Tooltip = /*#__PURE__*/function (_BaseComponent) {
  ...
  _proto.show = function show() {
    ...
    if (this.isWithContent() && this._isEnabled) {
      ...
      this._popper = (0, Popper.createPopper)(this._element, tip, this._getPopperConfig(attachment));
...
//# sourceMappingURL=/bootstrapTest.e31bb0bc.js.map